...
The same `.github/vale` (this repo) is used across projects, thus
ensuring consistency, but the `.vale.ini` is specific to each project
since the linting targets vary.
